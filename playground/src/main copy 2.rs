...
use rsa::{RSAPrivateKey, PaddingScheme, hash::Hashes};


//use no_way::{ClaimsSet, RegisteredClaims, JWT, jwa::sign};
...
-----END PRIVATE KEY-----";
 ...
 let test = "eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9.eyJpc3MiOiJNU19GTEVYIiwic3ViIjoiWjkyN1NZIiwiZG9tYWluIjoiIiwiaW5pdGlhbFN1YiI6IiIsImRvbWFpbiI6IiIsImlhdCI6MTY5MTA0ODk3OCwiZXhwIjoxNjkxMDU2MTc4LCJjdXN0b21EYXRhIjp7fSwiY29udGV4dFZlcnNpb24iOiIiLCJpbml0aWFsQ2xpZW50SWQiOm51bGwsImFtciI6bnVsbH0";
...
//let signing_key = jwk::OctetKey::new(private_key.to_string().into_bytes());


//let jwt = JWT::new(jwt_claims);
//let jws_token = jwt.encode::<sign::RS256>(&signing_key).unwrap();

//println!("Debug: {:?}", jws_token);
//println!("JWT: {}", jws_token.to_string());
